...
system "mount -t ext4 /dev/sdb /home/ssiva/COM_DIR/"

#mount FUSE FS (default) on top of EXT4
system "/home/ssiva/fuse-playground/StackFS_LowLevel/StackFS_ll --statsdir=/tmp/ -o max_write=131072 -o writeback_cache -o splice_read -o splice_write -o splice_move -r /home/ssiva/COM_DIR/EXT4_FS/ /home/ssiva/COM_DIR/FUSE_EXT4_FS/ > /dev/null &"

system "sleep 2"

#Increase the number of user threads to 100
system "echo 100 > /sys/fs/fuse/connections/`stat --format '%d' /home/ssiva/COM_DIR/FUSE_EXT4_FS/`/max_background"
